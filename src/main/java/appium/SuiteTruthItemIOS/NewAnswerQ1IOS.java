...
import appium.SuiteTruthItemIOS.TestSuiteBaseTIIOS;
...
public class NewAnswerQ1IOS extends TestSuiteBaseTIIOS {
  ...
  public void checkTestSkip() {
	  ...
	  public void TestPrimaryRoleAnd(String col1, String col2, String col3, String col4, String col5, String col6, String col7) throws Throwable {
	      ...
	      //Login
	    	...
	    	WebElement getLocationQ1=driver.findElement(MobileBy.xpath(OR.getProperty("deliverableQ1EditIOS")));
	    	wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(MobileBy.xpath(OR.getProperty("deliverableQ1EditIOS"))));
	    	...
	    	driver.findElement(MobileBy.xpath(OR.getProperty("deliverableQ1EditIOS"))).clear();
	    	driver.findElement(MobileBy.xpath(OR.getProperty("deliverableQ1EditIOS"))).sendKeys("Deliverable Q1 Answer");
	    	APP_LOGS.debug("Deliverable question 1 was updated");
	    	...
	    	question1Answer = driver.getPageSource().contains("Deliverable Q1 Answer");
	    	
	    	if(question1Answer == true){
        		APP_LOGS.debug("Question 1 answer was found");
        		pass=true;
                fail=false;
                isTestPass=true;
                FinalMessage = "Question 1 answer was found";
                org.testng.Assert.assertTrue(pass);
                    ...
                    fail=true;
                    isTestPass=false;
        			APP_LOGS.debug("Question 1 answer wasn't found");
        			FinalMessage = "Question 1 answer wasn't found";
        			org.testng.Assert.fail("Question 1 answer wasn't found");
        			//sa.fail();
        		}
	  }

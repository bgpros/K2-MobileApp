...
public class TestChangePrimaryTechAndroid extends TestSuiteBaseTIAndroid {
  ...
  public void checkTestSkip() {
	  ...
	  public void TestPrimaryRoleAnd(String col1, String col2, String col3, String col4, String col5, String col6, String col7) throws Throwable {
		  count++;
	    	...
	    	wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(MobileBy.xpath(OR.getProperty("secondTITechnologyAndroid"))));
	    	driver.findElement(MobileBy.xpath(OR.getProperty("secondTITechnologyAndroid"))).click();
	    	...
	    	if(primaryInd == true){
        		APP_LOGS.debug("Primary Technology tag was found and changed");
        		pass=true;
                fail=false;
                isTestPass=true;
                org.testng.Assert.assertTrue(pass);
                FinalMessage = "Primary Technology was found and changed";
                
        		}else{
        			pass=false;
                    fail=true;
                    isTestPass=false;
        			APP_LOGS.debug("Primary technology wasn't found and changed");
        			FinalMessage = "Primary technology wasn't found and changed";
        			//sa.fail();
        		}

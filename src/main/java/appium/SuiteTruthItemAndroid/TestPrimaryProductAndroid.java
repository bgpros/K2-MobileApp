...
public class TestPrimaryProductAndroid extends TestSuiteBaseTIAndroid {
	  ...
	  public void TestPrimaryRoleAnd(String col1, String col2, String col3, String col4, String col5, String col6, String col7) throws Throwable {
	      ...
	      //Login
	    	...
	    	if(primaryIndustry == true){
        		APP_LOGS.debug("Primary Product tag was found");
        		pass=true;
                fail=false;
                isTestPass=true;
                FinalMessage = "Primary Product was found";
                org.testng.Assert.assertTrue(pass);
                    ...
                    fail=true;
                    isTestPass=false;
        			APP_LOGS.debug("Primary Product wasn't found");
        			FinalMessage = "Primary Product wasn't found";
        			//sa.fail();
        		}
	  }

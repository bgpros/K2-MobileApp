...
public class TestChangePrimaryRoleAndroid extends TestSuiteBaseTIAndroid {
    ...
    String FinalMessage = "";  
    public boolean primaryRole = false;
  ...
  public void checkTestSkip() {
	  ...
	  public void TestPrimaryRoleAnd(String col1, String col2, String col3, String col4, String col5, String col6, String col7) throws Throwable {
		  count++;
	    	...
	    	APP_LOGS.debug("Project Role was found and clicked");
	
	    	//Click to another Role to change the Primary
	    	wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(MobileBy.xpath(OR.getProperty("secondTIRoleAndroid"))));
	    	driver.findElement(MobileBy.xpath(OR.getProperty("secondTIRoleAndroid"))).click();
	    	...
	    	primaryRole = driver.getPageSource().contains("Primary");
	    	
	    	if(primaryRole == true){
        		APP_LOGS.debug("Primary Role tag was found and changed");
        		pass=true;
                fail=false;
                isTestPass=true;
                org.testng.Assert.assertTrue(pass);
                FinalMessage = "Primary Role was found and changed";
                
        		}else{
        			pass=false;
                    fail=true;
                    isTestPass=false;
        			APP_LOGS.debug("Primary Role wasn't found and changed");
        			FinalMessage = "Primary Role wasn't found and changed";
        			//sa.fail();
        		}

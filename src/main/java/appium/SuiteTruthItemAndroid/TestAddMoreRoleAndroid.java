...
public class TestAddMoreRoleAndroid extends TestSuiteBaseTIAndroid {
  ...
  public void checkTestSkip() {
	  ...
	  public void TestPrimaryRoleAnd(String col1, String col2, String col3, String col4, String col5, String col6, String col7) throws Throwable {
		  count++;
	    	...
	    	APP_LOGS.debug("Role was found and clicked");
	
        	//Click on Add other Product
	    	wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(MobileBy.id(OR.getProperty("roleAddEditAndroid"))));
	    	driver.findElement(MobileBy.id(OR.getProperty("roleAddEditAndroid"))).click();
	    	APP_LOGS.debug("Add other Role");
	    	
        	//Click on the Role that wanted to be added
	    	wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(MobileBy.xpath(OR.getProperty("accountingCoordinatorEditAndroid"))));
	    	driver.findElement(MobileBy.xpath(OR.getProperty("accountingCoordinatorEditAndroid"))).click();
	    	APP_LOGS.debug("Accounting Coordinator Added");
	    	
	    	//Click on Accounting manager
	    	wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(MobileBy.xpath(OR.getProperty("accountingManagerEditAndroid"))));
	    	driver.findElement(MobileBy.xpath(OR.getProperty("accountingManagerEditAndroid"))).click();
	    	APP_LOGS.debug("Accounting Manager Added");
	    	
	    	//Click on Architect Technical
	    	wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(MobileBy.xpath(OR.getProperty("arquitectTechnicalEditAndroid"))));
	    	driver.findElement(MobileBy.xpath(OR.getProperty("arquitectTechnicalEditAndroid"))).click();
	    	APP_LOGS.debug("Architects Technilcal Added");
	    	...
	    	APP_LOGS.debug("First Role from the list is found");

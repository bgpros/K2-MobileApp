...
public class TestPrimaryRoleAndroid extends TestSuiteBaseTIAndroid {
  ...
  public void checkTestSkip() {
	  ...
	  public void TestPrimaryRoleAnd(String col1, String col2, String col3, String col4, String col5, String col6, String col7) throws Throwable {
		  count++;
	    	...
	    	if(primaryRole == true){
        		APP_LOGS.debug("Primary Role tag was found");
        		pass=true;
                fail=false;
                isTestPass=true;
                org.testng.Assert.assertTrue(pass);
                FinalMessage = "Primary Role was found";
                
        		}else{
        			pass=false;
                    fail=true;
                    isTestPass=false;
        			APP_LOGS.debug("Primary Role wasn't found");
        			FinalMessage = "Primary Role wasn't found";
        			//sa.fail();
        		}
	  }

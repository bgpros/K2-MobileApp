...
public class TestPrimaryIndustryAndroid extends TestSuiteBaseTIAndroid {
	  ...
	  public void TestPrimaryRoleAnd(String col1, String col2, String col3, String col4, String col5, String col6, String col7) throws Throwable {
	      ...
	      //Login
	    	...
	    	if(primaryIndustry == true){
        		APP_LOGS.debug("Primary Industry tag was found");
        		pass=true;
                fail=false;
                isTestPass=true;
                FinalMessage = "Primary Industry was found";
                org.testng.Assert.assertTrue(pass);
                    ...
                    fail=true;
                    isTestPass=false;
        			APP_LOGS.debug("Primary Industry wasn't found");
        			FinalMessage = "Primary Industry wasn't found";
        			//sa.fail();
        		}
	  }

...
public class TestPrimaryTechnologyAndroid extends TestSuiteBaseTIAndroid {
    ...
    String FinalMessage = "";  
    public boolean primaryIndustry = false;
  ...
  public void checkTestSkip() {
	  ...
	  public void TestPrimaryRoleAnd(String col1, String col2, String col3, String col4, String col5, String col6, String col7) throws Throwable {
	      ...
	      //Login
	    	...
	    	primaryIndustry = driver.getPageSource().contains("Primary");
	    	
	    	if(primaryIndustry == true){
        		APP_LOGS.debug("Primary Technology tag was found");
        		pass=true;
                fail=false;
                isTestPass=true;
                FinalMessage = "Primary Technology was found";
                org.testng.Assert.assertTrue(pass);
                    ...
                    fail=true;
                    isTestPass=false;
        			APP_LOGS.debug("Primary Technology wasn't found");
        			FinalMessage = "Primary Technology wasn't found";
        			//sa.fail();
        		}
	  }

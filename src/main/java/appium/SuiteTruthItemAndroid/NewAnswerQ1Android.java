...
public class NewAnswerQ1Android extends TestSuiteBaseTIAndroid {
  ...
  public void checkTestSkip() {
	  ...
	  public void TestPrimaryRoleAnd(String col1, String col2, String col3, String col4, String col5, String col6, String col7) throws Throwable {
	      ...
	      //Login
	    	...
	    	wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(MobileBy.id(OR.getProperty("deliverableQ1EditAndroid"))));
	    	driver.findElement(MobileBy.id(OR.getProperty("deliverableQ1EditAndroid"))).sendKeys("Answer for question 1 posted by script");
	    	...
	    	question1Answer = driver.getPageSource().contains("Answer for question 1 posted by script");

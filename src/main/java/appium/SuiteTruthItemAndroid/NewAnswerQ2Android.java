...
public class NewAnswerQ2Android extends TestSuiteBaseTIAndroid {
    ...
    String FinalMessage = "";  
    public boolean question2Answer = false;
  ...
  public void checkTestSkip() {
	  ...
	  public void TestPrimaryRoleAnd(String col1, String col2, String col3, String col4, String col5, String col6, String col7) throws Throwable {
	      ...
	      //Login
	    	...
	    	wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(MobileBy.id(OR.getProperty("deliverableQ2EditAndroid"))));
	    	driver.findElement(MobileBy.id(OR.getProperty("deliverableQ2EditAndroid"))).sendKeys("New answer for question 2");
	    	...
	    	question2Answer = driver.getPageSource().contains("New answer for question 2");
